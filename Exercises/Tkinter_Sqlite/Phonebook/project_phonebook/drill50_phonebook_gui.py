...
def load_gui(self): #self is the key
    ...
    self.lstList1.bind('<<ListboxSelect>>',lambda event: drill50_phonebook_func.onSelect(self,event)) # a listener to detect if a user selects something in the list calls function "onselect()"
