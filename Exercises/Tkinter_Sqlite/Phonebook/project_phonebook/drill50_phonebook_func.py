...
def first_run(self):
    ...
    with conn:  # = if successful
        ...
        if count < 1:
            cur.execute("INSERT INTO tbl_phonebook (col_fname,col_lname,col_fullname,col_phone,col_email) VALUES (?,?,?,?,?)", ('John','Doe','John Doe','111-111-1111','jdoe@email.com')) # removed extra """
            conn.commit()
    conn.close() 
