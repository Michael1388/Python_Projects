...
class ParentWindow(Frame): 
    def __init__(self, master, *args, **kwargs):
        ...
        drill50_phonebook_func.center_window(self,500,300) # have to pass in self, it is the place we are working in and referring to
        ...
        drill50_phonebook_gui.load_gui(self) # have to pass in self
