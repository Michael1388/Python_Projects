...
# 
# Python Course
# File Transfer Project Assignment   
# Step 310,311,312
# 
...
class ParentWindow(Frame):
    ...
    # Creates funciton to select source directory.
    def sourceDir(self):
    ...
    def exit_program(self):
        ...
        # tells Python to terminate root.mainloop and all widgets 
        # inside teh GUI window
        root.destroy()
